...
enum PoStatus: string
{
    ...
    public function allowedTransitions(): array
    {
        return match ($this) {
            ...
            self::DITERUSKAN_KE_SUPPLIER => [self::DIPROSES_SUPPLIER, self::DIBATALKAN, self::DITERIMA_SEBAGIAN, self::DITERIMA_LENGKAP, self::MENUNGGU_VERIFIKASI_DAPUR],
            self::DIPROSES_SUPPLIER => [self::DALAM_PENGIRIMAN, self::DIBATALKAN, self::DITERIMA_SEBAGIAN, self::DITERIMA_LENGKAP, self::MENUNGGU_VERIFIKASI_DAPUR],
            self::DALAM_PENGIRIMAN => [self::DITERIMA_SEBAGIAN, self::DITERIMA_LENGKAP, self::MENUNGGU_VERIFIKASI_DAPUR],
