    ...
    public function up(): void
    {
        ...
        DB::unprepared('
            ...
            BEGIN
                ...
                SET id_debit = CAST(CONCAT(kode_debit_clean, tahun_pembayaran, NEW.dapur_id) AS UNSIGNED);
                SET id_kredit = CAST(CONCAT(kode_kredit_clean, tahun_pembayaran, NEW.dapur_id) AS UNSIGNED);
        ...
        DB::unprepared('
            ...
            BEGIN
                ...
                SET id_debit_old = CAST(CONCAT(kode_debit_old_clean, tahun_old, OLD.dapur_id) AS UNSIGNED);
                SET id_kredit_old = CAST(CONCAT(kode_kredit_old_clean, tahun_old, OLD.dapur_id) AS UNSIGNED);
                SET id_debit_new = CAST(CONCAT(kode_debit_new_clean, tahun_new, NEW.dapur_id) AS UNSIGNED);
                SET id_kredit_new = CAST(CONCAT(kode_kredit_new_clean, tahun_new, NEW.dapur_id) AS UNSIGNED);
        ...
        DB::unprepared('
            ...
            BEGIN
                ...
                SET id_debit = CAST(CONCAT(kode_debit_clean, tahun_pembayaran, OLD.dapur_id) AS UNSIGNED);
                SET id_kredit = CAST(CONCAT(kode_kredit_clean, tahun_pembayaran, OLD.dapur_id) AS UNSIGNED);
