<aside
    ...
    :class="sidebarOpen ? 'w-64 opacity-100' : 'w-0 lg:w-0 opacity-0 pointer-events-none'" 
    x-cloak>
    ...
    <div class="flex items-center gap-3 px-5 py-7">
        ...
        <span class="text-[17px] font-extrabold text-slate-900 tracking-tight">Yayasan <span class="text-green-800">MBG</span></span>
    </div>
    ...
    @php
        $navGroups = [
            ...
            [
                ...
                'items' => [
                    ['route' => 'materials.index', 'match' => 'materials.*', 'label' => 'Bahan Baku', 'icon' => 'material'],
                    ['route' => 'menu-items.index', 'match' => 'menu-items.*', 'label' => 'Daftar Menu', 'icon' => 'menu'],
                    ['route' => 'menu-periods.index', 'match' => 'menu-periods.*', 'label' => 'Perencanaan Menu', 'icon' => 'planning'],
                    ['route' => 'purchase-orders.index', 'match' => 'purchase-orders.*', 'label' => 'Purchase Orders', 'icon' => 'material'],
                ]
            ],
            [
                'label' => 'Logistik & SCM',
            ...
            [
                ...
                'items' => [
                    ['route' => 'kitchen.index', 'match' => 'kitchen.index', 'label' => 'Dashboard Masak', 'icon' => 'kitchen'],
                    ['route' => 'kitchen.inventory', 'match' => 'kitchen.inventory', 'label' => 'Inventaris Unit', 'icon' => 'planning'],
                ]
            ],
            [
            ...
            [
                ...
                'role' => 'supplier',
                'items' => [
                    ['route' => 'supplier.purchase-orders.index', 'match' => 'supplier.*', 'label' => 'Pesanan Saya', 'icon' => 'material'],
                ]
            ],
            [
            ...
            [
                ...
                'items' => [
                    ...
                    ['route' => 'profile.edit', 'match' => 'profile.edit', 'label' => 'Pengaturan', 'icon' => 'settings'],
                ]
            ]
        ];
        ...
        $icons = [
            ...
            'material' => '<path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01m-.01 4h.01"/>',
            'menu' => '<path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />',
            ...
            'dapur' => '<path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>',
            'supplier' => '<path d="M21 8V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2h10M17 13l3 3m0 0l-3 3m3-3H8" />',
            'investor' => '<path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>',
            'period' => '<path d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>',
    ...
    <nav class="flex flex-col gap-1 pb-10">
        @foreach ($navGroups as $group)
            @php
                $visible = !isset($group['role']) || 
                           (is_array($group['role']) ? auth()->user()->hasAnyRole($group['role']) : auth()->user()->hasRole($group['role']));
            @endphp
            @if($visible)
                <div class="px-5 pt-5 pb-2">
                    <p class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">{{ $group['label'] }}</p>
                </div>
        ...
        <div class="mt-4 pt-4 border-t border-slate-50">
            <form action="{{ route('logout') }}" method="POST">
                ...
                <button type="submit"
                    ...
                    <svg class="w-4.5 h-4.5 shrink-0 transition-transform group-hover:-translate-x-0.5" fill="none"
