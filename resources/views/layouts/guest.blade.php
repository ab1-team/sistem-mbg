...
<body
    class="font-sans antialiased text-slate-800 bg-white min-h-screen selection:bg-emerald-900/10 selection:text-emerald-900">
    <div
        class="min-h-screen flex flex-col items-center justify-center p-6 sm:p-12 relative overflow-hidden bg-slate-50/30">

        <!-- Branding Header (Above Card) -->
        <div class="mb-8 text-center animate-reveal" style="animation-delay: 0.1s">
            <div
                class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white border border-slate-100 shadow-sm mb-6 group hover:scale-105 transition-transform duration-500">
                <span class="font-bold text-xl text-emerald-700 leading-none tracking-tight">MBG</span>
            </div>
            <h2 class="text-2xl font-bold text-slate-900 tracking-tight leading-none uppercase">
                YAYASAN <span class="text-emerald-700">MBG</span>
            </h2>
        ...
        <div class="w-full max-w-[440px] bg-white rounded-2xl shadow-sm border border-slate-100 p-8 sm:p-12 animate-reveal"
