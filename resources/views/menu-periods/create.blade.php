<x-app-layout title="Buat Rencana Menu">
    <div class="mb-6">
        ...
        <h1 class="text-[28px] font-extrabold text-slate-900 tracking-tight leading-none">Buat Rencana Menu Baru</h1>
        <p class="text-[13px] text-slate-400 mt-2">Pilih unit dapur dan periode untuk mulai menjadwalkan menu harian.</p>
    </div>
