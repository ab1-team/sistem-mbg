<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-6">
        ...
        <x-form-input label="Password Saat Ini" name="current_password" id="update_password_current_password"
            type="password" />
        <x-form-input label="Password Baru" name="password" id="update_password_password" type="password" />
        <x-form-input label="Konfirmasi Password Baru" name="password_confirmation"
