            ...
            <div class="bg-brand-soft border border-emerald-100 rounded-3xl p-6">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-[12px] text-emerald-600 font-medium leading-relaxed mt-1">Periode yang berstatus 'Closed' tidak dapat menerima transaksi baru untuk menjaga integritas data audit.</p>
                    </div>
                </div>
            </div>
        </div>
