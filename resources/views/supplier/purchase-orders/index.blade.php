<x-app-layout title="Pesanan Saya">
    <div class="mb-6">
        <h1 class="text-[28px] font-extrabold text-slate-900 tracking-tight leading-none">Pesanan Saya</h1>
        <p class="text-[13px] text-slate-500 font-medium mt-2">Daftar pesanan bahan baku dari Yayasan MBG.</p>
    </div>
