            ...
            <div class="bg-indigo-50 border border-indigo-100 rounded-3xl p-6">
                <div class="flex items-start gap-4">
                     ...
                     <div>
                         ...
                         <p class="text-[12px] text-indigo-600 font-medium leading-relaxed mt-1">Status Non-Aktif akan menghentikan seluruh perhitungan pembagian laba harian untuk investor ini.</p>
                     </div>
                </div>
            </div>
        </div>
