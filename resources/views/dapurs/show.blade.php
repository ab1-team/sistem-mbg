    ...
    <x-container>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 space-y-6">
                <x-card title="Informasi Utama" subtitle="Identitas operasional unit dapur.">
                ...
                <x-card title="Lokasi & Alamat" subtitle="Informasi geografis unit dapur.">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                ...
                <div class="bg-emerald-50/50 border border-emerald-100 rounded-3xl p-6">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-2xl bg-white text-emerald-600 flex items-center justify-center shadow-sm border border-emerald-100">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        </div>
                        <div>
                            <h4 class="text-[14px] font-black text-emerald-900 capitalize">Statistik Unit</h4>
                            <p class="text-[12px] text-emerald-600 font-bold leading-relaxed mt-0.5">Unit operasional terdaftar.</p>
                        </div>
                    </div>
                </div>
            </div>
