...
<div class="space-y-1.5" x-data="{ fileName: '' }">
    @if($label)
        <label class="block text-[12px] font-medium text-slate-500">
    ...
    <div class="relative group">
        ...
        {{-- Styled Mask --}}
        <div class="flex items-center gap-3 w-full bg-slate-50 border border-slate-100 text-slate-900 text-[13px] rounded-xl px-4 py-2.5
            ...
            <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:text-emerald-600 transition-colors">Telusuri</span>
        </div>
    </div>
