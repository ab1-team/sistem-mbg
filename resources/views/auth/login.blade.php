<x-guest-layout title="Masuk Ke Sistem">
    ...
    <div class="mb-8 text-center animate-reveal" style="animation-delay: 0.1s">
        <h3 class="text-2xl font-bold text-slate-900 tracking-tight leading-none mb-3">
            Masuk ke <span class="text-green-800 font-extrabold">Dashboard</span>
        </h3>
    ...
    <!-- Login Form -->
    <form method="POST" action="{{ route('login') }}" class="space-y-8 animate-reveal"
        ...
        <div class="space-y-3">
            <x-form-input 
                ...
                required 
                autofocus 
                placeholder="admin@yayasan-mbg.id"
            >
                <x-slot name="icon">
        ...
        <div class="space-y-3">
            <div class="relative">
                ...
                @if (Route::has('password.request'))
                    <a class="absolute top-0 right-1 text-[10px] font-semibold text-green-800 hover:text-green-700 uppercase tracking-widest transition-all"
        ...
        <div class="flex items-center group cursor-pointer">
            <input id="remember_me" type="checkbox"
                class="w-5 h-5 rounded-lg border-slate-200 bg-slate-50 text-green-900 focus:ring-green-900/10 cursor-pointer transition-all duration-300"
                name="remember">
        ...
        <div class="text-center">
            <p class="text-[12px] text-slate-500 font-medium">
                ...
                <a href="{{ route('register') }}"
                    class="text-green-800 hover:text-green-700 transition-all font-semibold underline underline-offset-4 decoration-green-800/20">
                    Hubungi Admin
                </a>
            </p>
        </div>
